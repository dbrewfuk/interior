...
var _supports2 = _interopRequireWildcard(_supports);
  ...
  return (function (e, t, r, a) {
    function n(e) {
      ...
      function o(e, t) {
        ...
        for (var n = 0; m > n; ++n) {
          var o = u(r, e, a);if (0 === o) {
            return r;
          }var i = l(r, e, a) - t;r -= i / o;
        }return r;
      }function p() {
        ...
        V = !0, (e != r || a != n) && p();
          ...
          b = 11,
          x = 1 / (b - 1),
          S = ("Float32Array" in t);if (4 !== arguments.length) {
        return !1;
      ...
      function e() {
        ...
        function e(e) {
          function p(e, t) {
            ...
            }"none" === i(n).opts.display && (i(n).opts.display = "auto"), "hidden" === i(n).opts.visibility && (i(n).opts.visibility = "visible"), i(n).opts.loop = !1, i(n).opts.begin = null, i(n).opts.complete = null, b.easing || delete o.easing, b.duration || delete o.duration, o = $.extend({}, i(n).opts, o);var E = $.extend(!0, {}, i(n).tweensContainer);for (var j in E) if ("element" !== j) {
